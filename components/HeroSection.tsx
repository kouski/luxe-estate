        ...
        <section className="py-12 md:py-16">
            <div className="max-w-3xl mx-auto text-center space-y-8">
                ...
                <div className="relative group max-w-2xl mx-auto">
                    ...
                    <input
                        className="block w-full pl-12 pr-4 py-4 rounded-xl border-none outline-none ring-0 bg-white dark:bg-white/5 text-nordic-dark dark:text-white shadow-soft placeholder-nordic-muted/60 focus:ring-2 focus:ring-mosque focus:bg-white dark:focus:bg-white/10 transition-all text-lg"
                ...
                <div className="flex items-center justify-center gap-3 overflow-x-auto hide-scroll py-2 px-4 -mx-4">
                    ...
                    <button className="whitespace-nowrap flex items-center gap-1 px-4 py-2 rounded-full text-nordic-dark font-medium text-sm hover:bg-black/5 dark:text-gray-300 dark:hover:bg-white/5 transition-colors">
